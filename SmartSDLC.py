...
Original file is located at
    https://colab.research.google.com/drive/1ZfqZQMoZpCRQ4nrKnizicUFYZm1kx436
"""
...
def requirement_analysis(pdf_file, prompt_text):
    ...
    if pdf_file is not None:
        ...
        analysis_prompt = f"Analyze the following and extract key software requirements. Organize them into functional requirements, non-functional requirements:\n\n{content}" # Added content to prompt
    else:
        analysis_prompt = f"Analyze the following requirements and organize them into functional requirements, non_functional requirements, and technical specifications:\n\n{prompt_text}" # Added prompt_text to prompt
...
with gr.Blocks() as app:
    gr.Markdown("# CodeGenie: AI for Smarter SDLC")
